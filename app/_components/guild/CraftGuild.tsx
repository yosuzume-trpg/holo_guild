    ...
    return (
        <div className="p-4 space-y-4">
            ...
            <FacilityStatsBox
                ...
                onExpand={() => {
                    if (spendGold(expandCost)) expandGuild("craft");
                }}
                onResearch={() => {
                    if (spendGold(researchCost)) researchGuild("craft");
                }}
                                    ...
                                    return (
                                        <ItemTile
                                            ...
                                            ingredients={recipe.ingredients.map((ing) => ({
                                                name:
                                                    getMaterial(ing.materialId)?.name ??
                                                    ing.materialId,
                                                qty: ing.qty,
                    ...
                    <div>
                        ...
                        {editing ? (
                            <div className="text-sm text-ink px-2 py-1.5">
                                {editMaster?.name ?? editCharId} (工芸Lv.{editChar?.craftLevel})
                            </div>
                        ) : (
                            <CharacterPicker

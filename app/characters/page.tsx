...
const SORT_LABELS: Record<SortKey, string> = {
  ...
  ...Object.fromEntries(
    (Object.keys(SORT_CONFIG) as NumericSortKey[]).map((k) => [
      k,
      SORT_CONFIG[k].label,
    ]),
  ),
...
const PRODUCTION_ASSIGNMENTS = new Set([
  "farm",
  "mining",
  "fishing",
  "alchemy",
...
export default function CharactersPage() {
  ...
  if (characters.length === 0) {
    return (
      <div className="p-4 text-center text-ink-muted mt-12">
        キャラクターがまだいません
      </div>
    );
  }
